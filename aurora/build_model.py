...
tongue_shapes = pl.read_csv("data/tongue_model.csv")
...
# save as pickle
with open("data/tongue_model.pkl", "wb") as f:
...
tongue_shapes_m = pl.read_csv("data/tongue_model_m.csv")
...
# save as pickle
with open("data/tongue_model_m.pkl", "wb") as f:
